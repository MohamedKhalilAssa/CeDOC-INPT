...
-- Format: $2a$10$saltHashedPassword
-- Plaintext password for all test users: "Test@1234"
INSERT INTO utilisateurs (id, created_at, date_naissance, email, email_valider, etat_civil, genre, nom, password, prenom, telephone, updated_at, lieu_naissance_id, nationalite_id) VALUES
-- Admin (password: Test@1234)
(1, NOW(), '1980-01-15', 'admin@university.edu', 1, 'MARIER', 'HOMME', 'Admin', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'System', '0612345678', NOW(), 1, 1),

-- Professors (password: Test@1234)
(2, NOW(), '1975-05-20', 'prof1@university.edu', 1, 'MARIER', 'HOMME', 'Smith', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'John', '0612345679', NOW(), 2, 2),
(3, NOW(), '1980-08-12', 'prof2@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Johnson', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Alice', '0612345680', NOW(), 3, 1),
(4, NOW(), '1978-11-30', 'prof3@university.edu', 1, 'MARIER', 'HOMME', 'Williams', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Robert', '0612345681', NOW(), 4, 3),
(5, NOW(), '1982-03-25', 'prof4@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Brown', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Emily', '0612345682', NOW(), 5, 4),
(6, NOW(), '1970-07-18', 'prof5@university.edu', 1, 'DIVORCER', 'HOMME', 'Davis', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Michael', '0612345683', NOW(), 6, 5),

-- Doctoral students (password: Test@1234)
(7, NOW(), '1990-02-10', 'doc1@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Martin', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Thomas', '0612345684', NOW(), 7, 1),
(8, NOW(), '1991-06-22', 'doc2@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Garcia', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Sophia', '0612345685', NOW(), 8, 1),
(9, NOW(), '1989-09-15', 'doc3@university.edu', 1, 'MARIER', 'HOMME', 'Lee', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'David', '0612345686', NOW(), 9, 2),
(10, NOW(), '1992-04-05', 'doc4@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Wilson', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Emma', '0612345687', NOW(), 10, 1),
(11, NOW(), '1988-12-30', 'doc5@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Anderson', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'James', '0612345688', NOW(), 1, 3),

-- Candidates (password: Test@1234)
(12, NOW(), '1993-07-14', 'cand1@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Taylor', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'William', '0612345689', NOW(), 2, 2),
(13, NOW(), '1994-01-25', 'cand2@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Moore', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Olivia', '0612345690', NOW(), 3, 1),
(14, NOW(), '1992-10-08', 'cand3@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Jackson', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Benjamin', '0612345691', NOW(), 4, 4),

-- Direction CEDOC (password: Test@1234)
(15, NOW(), '1972-09-17', 'dir1@university.edu', 1, 'MARIER', 'HOMME', 'White', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Richard', '0612345692', NOW(), 5, 1),
(16, NOW(), '1975-11-23', 'dir2@university.edu', 1, 'MARIER', 'FEMME', 'Harris', '$2a$10$xn3LI/AjqicFYZFruSwve.681477XaVNaUQbr1gioaWPn4t1KsnmG', 'Jennifer', '0612345693', NOW(), 6, 2);
...
-- Professors (all get PROFESSEUR role)
(2, 2),
(3, 2),
(4, 2),
(5, 2),
...
-- Insert professors (extends utilisateur)
...
-- Insert team leaders (chefs_equipes extends professeurs)
INSERT INTO chefs_equipes (id) VALUES (2), (3);

-- Update research teams with their leaders
UPDATE equipes_de_recherches SET chef_equipe_id = 2 WHERE id = 1;
UPDATE equipes_de_recherches SET chef_equipe_id = 3 WHERE id = 2;

-- Insert thesis directors (directeurs_de_theses extends professeurs)
INSERT INTO directeurs_de_theses (id) VALUES (4), (5);

-- Insert formation managers (responsables_de_formations extends professeurs)
INSERT INTO responsables_de_formations (id) VALUES (6);

-- Insert direction cedoc (extends utilisateur)
INSERT INTO direction_cedoc (role_administrative, id) VALUES
('DIRECTEUR', 15),
('RESPONSABLE', 16);

-- Insert candidates (extends utilisateur)
INSERT INTO candidats (archiver, id) VALUES
(0, 12),
(0, 13),
(0, 14);

-- Insert doctoral students (extends utilisateur)
INSERT INTO doctorants (nombre_heures_labo, archiver, date_inscription, draft_diplome_url, statut_doctorant, id, directeur_id, equipe_de_recherche_id, sujet_id) VALUES
...
INSERT INTO sujets (id, created_at, description, est_public, intitule, updated_at, est_valide, chef_equipe_id, directeur_these_id) VALUES
...
-- Insert candidatures
INSERT INTO candidatures (id, created_at, dossier_candidature, intitule_pfe, mention_bac, mention_diplome, specialite, statut_candidature, statut_professionnel, type_etablissement, updated_at, candidat_id) VALUES
(1, NOW(), 'dossier1.pdf', 'Système de recommandation', 'B', 'TB', 'Informatique', 'SOUMISE', 'NON_SALARIE', 'UNIVERSITE', NOW(), 12),
(2, NOW(), 'dossier2.pdf', 'Analyse de sentiments', 'TB', 'B', 'Data Science', 'EN_COURS_DE_TRAITEMENT', 'SALARIE', 'ECOLE', NOW(), 13),
(3, NOW(), 'dossier3.pdf', 'Blockchain pour la santé', 'AB', 'AB', 'Cryptographie', 'ACCEPTER', 'NON_SALARIE', 'UNIVERSITE', NOW(), 14);
...
INSERT INTO demandes_reinscriptions (id, certificat_travail, annee, attestation_honneur, created_at, demande_derogation, plan_action, rapport_avancement, residance, updated_at, doctorant_id, sujet_id) VALUES
(1, 'certificat1.pdf', 2023, 'attestation1.pdf', NOW(), 'derogation1.pdf', 'plan1.pdf', 'rapport1.pdf', 1, NOW(), 7, 1),
(2, 'certificat2.pdf', 2023, 'attestation2.pdf', NOW(), 'derogation2.pdf', 'plan2.pdf', 'rapport2.pdf', 0, NOW(), 8, 2),
(3, 'certificat3.pdf', 2023, 'attestation3.pdf', NOW(), 'derogation3.pdf', 'plan3.pdf', 'rapport3.pdf', 1, NOW(), 9, 3);

-- Insert avis_reinscriptions
INSERT INTO avis_reinscriptions (id, avis_final, created_at, etat_avancement, observation, updated_at, demande_reinscription_id, directeur_these_id) VALUES
...
INSERT INTO demandes_soutenances (id, created_at, memoire_de_these, statut_demande, updated_at, directeur_de_these_id, direction_cedoc_id, soutenance_id) VALUES
(1, NOW(), 'memoire1.pdf', 'ACCEPTER', NOW(), 4, 15, 1),
(2, NOW(), 'memoire2.pdf', 'AJOURNEE', NOW(), 5, 16, 2),
(3, NOW(), 'memoire3.pdf', 'ACCEPTER', NOW(), 4, 15, 3);

-- Insert jury
INSERT INTO jury (id, created_at, updated_at, directeur_de_these_id, direction_cedoc_id) VALUES
(1, NOW(), NOW(), 4, 15),
(2, NOW(), NOW(), 5, 16),
(3, NOW(), NOW(), 4, 15);
