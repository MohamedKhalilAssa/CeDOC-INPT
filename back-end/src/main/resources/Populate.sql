...
-- Admin
(1, NOW(), '1980-01-15', 'admin@university.edu', 1, 'MARIER', 'HOMME', 'Admin', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'System', 'NON_SALARIE', '0612345678', NOW(), 1, 1),

-- Professors
(2, NOW(), '1975-05-20', 'prof1@university.edu', 1, 'MARIER', 'HOMME', 'Smith', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'John', 'NON_SALARIE', '0612345679', NOW(), 2, 2),
(3, NOW(), '1980-08-12', 'prof2@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Johnson', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Alice', 'NON_SALARIE', '0612345680', NOW(), 3, 1),
(4, NOW(), '1978-11-30', 'prof3@university.edu', 1, 'MARIER', 'HOMME', 'Williams', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Robert', 'NON_SALARIE', '0612345681', NOW(), 4, 3),
(5, NOW(), '1982-03-25', 'prof4@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Brown', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Emily', 'NON_SALARIE', '0612345682', NOW(), 5, 4),
(6, NOW(), '1970-07-18', 'prof5@university.edu', 1, 'DIVORCER', 'HOMME', 'Davis', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Michael', 'NON_SALARIE', '0612345683', NOW(), 6, 5),

-- Doctoral students
(7, NOW(), '1990-02-10', 'doc1@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Martin', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Thomas', 'NON_SALARIE', '0612345684', NOW(), 7, 1),
(8, NOW(), '1991-06-22', 'doc2@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Garcia', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Sophia', 'NON_SALARIE', '0612345685', NOW(), 8, 1),
(9, NOW(), '1989-09-15', 'doc3@university.edu', 1, 'MARIER', 'HOMME', 'Lee', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'David', 'NON_SALARIE', '0612345686', NOW(), 9, 2),
(10, NOW(), '1992-04-05', 'doc4@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Wilson', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Emma', 'NON_SALARIE', '0612345687', NOW(), 10, 1),
(11, NOW(), '1988-12-30', 'doc5@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Anderson', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'James', 'NON_SALARIE', '0612345688', NOW(), 1, 3),

-- Candidates
(12, NOW(), '1993-07-14', 'cand1@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Taylor', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'William', 'NON_SALARIE', '0612345689', NOW(), 2, 2),
(13, NOW(), '1994-01-25', 'cand2@university.edu', 1, 'CELIBATAIRE', 'FEMME', 'Moore', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Olivia', 'NON_SALARIE', '0612345690', NOW(), 3, 1),
(14, NOW(), '1992-10-08', 'cand3@university.edu', 1, 'CELIBATAIRE', 'HOMME', 'Jackson', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Benjamin', 'NON_SALARIE', '0612345691', NOW(), 4, 4),

-- Direction CEDOC
(15, NOW(), '1972-09-17', 'dir1@university.edu', 1, 'MARIER', 'HOMME', 'White', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Richard', 'NON_SALARIE', '0612345692', NOW(), 5, 1),
(16, NOW(), '1975-11-23', 'dir2@university.edu', 1, 'MARIER', 'FEMME', 'Harris', '$2a$10$5futZfOnSnlvLrzsdaAk2e7C3pY4M21bDsOlg8SeOs9tljT6UT0mS', 'Jennifer', 'NON_SALARIE', '0612345693', NOW(), 6, 2);
...
INSERT INTO doctorants (utilisateur_id, nombre_heures_labo, archiver, date_inscription, draft_diplome_url, statut_doctorant, directeur_role_id, equipe_de_recherche_id, sujet_id) VALUES
(7, 20, 0, '2020-09-01', NULL, 'EN_COURS', 4, 1, NULL),
(8, 15, 0, '2021-09-01', NULL, 'EN_COURS', 5, 2, NULL),
(9, 25, 0, '2019-09-01', NULL, 'SOUTENANCE_PROGRAMMER', 4, 1, NULL),
(10, 18, 0, '2022-09-01', NULL, 'EN_COURS', 5, 1, NULL),
(11, 30, 0, '2018-09-01', NULL, 'LAUREAT', 4, 2, NULL);
...
UPDATE doctorants SET sujet_id = 1 WHERE utilisateur_id = 7;
UPDATE doctorants SET sujet_id = 2 WHERE utilisateur_id = 8;
UPDATE doctorants SET sujet_id = 3 WHERE utilisateur_id = 9;
UPDATE doctorants SET sujet_id = 4 WHERE utilisateur_id = 10;
UPDATE doctorants SET sujet_id = 5 WHERE utilisateur_id = 11;
...
-- Insert formations
INSERT INTO formations (id, created_at, date_debut, details, duree, formation_name, image, intitule, lieu, module, nom_formateur, updated_at, professeur_utilisateur_id) VALUES
(1, NOW(), '2023-01-15', 'Formation approfondie en réseaux neuronaux', 30, 'Deep Learning Avancé', 'dl.jpg', 'DL Avancé', 'Labo 1', 'IA', 'Dr. Smith', NOW(), 2),
(2, NOW(), '2023-02-20', 'Sécurité des applications cloud natives', 20, 'Sécurité Cloud', 'cloud.jpg', 'Sec Cloud', 'Labo 2', 'CLOUD', 'Prof. Johnson', NOW(), 3),
(3, NOW(), '2023-03-10', 'Méthodes scientifiques et rédaction académique', 15, 'Méthodologie de Recherche', 'methodo.jpg', 'Méthodo Recherche', 'Salle 101', 'INFORMATIQUE', 'Dr. Williams', NOW(), 4);
...
INSERT INTO demandes_reinscriptions (id, annee, attestation_honneur, certificat_travail, created_at, demande_derogation, plan_action, rapport_avancement, residance, status, updated_at, direction_cedoc_id, chef_equipe_id, doctorant_id, sujet_id) VALUES
                                                                                                                                                                                                                                                         (1, 2023, 'attestation1.pdf', 'certificat1.pdf', NOW(), 'derogation1.pdf', 'plan1.pdf', 'rapport1.pdf', 1, 'VALIDEE', NOW(), 15, 2, 7, 1),
                                                                                                                                                                                                                                                         (2, 2023, 'attestation2.pdf', 'certificat2.pdf', NOW(), 'derogation2.pdf', 'plan2.pdf', 'rapport2.pdf', 0, 'VALIDEE_CHEF', NOW(), 16, 3, 8, 2),
                                                                                                                                                                                                                                                         (3, 2023, 'attestation3.pdf', 'certificat3.pdf', NOW(), 'derogation3.pdf', 'plan3.pdf', 'rapport3.pdf', 1, 'DECLAREE', NOW(), 15, 2, 9, 3);
...
(1, NOW(), '2022-10-10', 2, 'ENSA', 'justificatif1.pdf', 'Master', 'VALIDER', 'Introduction à le IA', NOW(), 7),
